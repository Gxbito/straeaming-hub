...
document.getElementById('tvForm').addEventListener('submit', function (event) {
    ...
    const formData = {
      firstName: document.getElementById('tvFirstName').value,
      lastName: document.getElementById('tvLastName').value,
      email: document.getElementById('tvEmail').value,
      phoneNumber: document.getElementById('tvPhoneNumber').value,
      postalCode: document.getElementById('tvPostalCode').value,
      platformPreference: document.getElementById('tvPlatformPreference').value
    };

    // Envía los datos a HubSpot
    var xhr = new XMLHttpRequest();
    var url = 'https://api.hsforms.com/submissions/v3/integration/submit/portalId/tvFormId'; // Reemplaza con tu URL de HubSpot
